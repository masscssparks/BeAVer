...
static NSString* const kSoundNameDefault = @"dingsound.mp3";
...
static NSString* const kSoundNameFirst = @"dingsound.mp3";
static NSString* const kSoundNameSecond = @"dingsound.mp3";
static NSString* const kSoundNameThird = @"dingsound.mp3";
