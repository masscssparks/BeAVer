...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
  ...
  if (self) {
    ...
    //self.navigationItem.title.textColor = [UIColor colorWithWhite:0.0 alpha:0.5];
...
- (void)initializeCell:(UITableViewCell *)cell
  ...
  if ([rowData isKindOfClass:[PacoExperimentDefinition class]]) {
    ...
    cell.imageView.image = [UIImage imageNamed:@"graphicon.png"];
    ...
    cell.textLabel.textColor = [UIColor babsonGreen];
