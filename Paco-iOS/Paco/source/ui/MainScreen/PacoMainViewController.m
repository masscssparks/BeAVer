...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
  ...
  if (self) {
    PacoTitleView *title = [PacoTitleView viewWithDefaultIconAndText:@"BeAVer"];
...
- (void)viewDidLoad {
  ...
  [buttonFind.button setBackgroundImage:[UIImage imageNamed:@"magglass.png"] forState:UIControlStateNormal];
  [buttonFind.button setBackgroundImage:[UIImage imageNamed:@"magglass.png"] forState:UIControlStateHighlighted];
  [buttonFind.button setBackgroundImage:[UIImage imageNamed:@"magglass.png"] forState:UIControlStateDisabled];
  ...
  [publicExperimentButton.button setBackgroundImage:[UIImage imageNamed:@"magglass.png"]
  ...
  [buttonExploreData.button setBackgroundImage:[UIImage imageNamed:@"graphicon.png"] forState:UIControlStateNormal];
  [buttonExploreData.button setBackgroundImage:[UIImage imageNamed:@"graphicon.png"] forState:UIControlStateHighlighted];
  [buttonExploreData.button setBackgroundImage:[UIImage imageNamed:@"graphicon.png"] forState:UIControlStateDisabled];
  ...
  [buttonUserGuide.button setBackgroundImage:[UIImage imageNamed:@"questionmark.png"] forState:UIControlStateNormal];
  ...
  [buttonFeedback.button setBackgroundImage:[UIImage imageNamed:@"contacticon.png"] forState:UIControlStateNormal];
