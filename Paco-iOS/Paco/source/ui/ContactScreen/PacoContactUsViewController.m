...
- (void)viewDidLoad {
  ...
  [buttonEmailUserGroup.button setBackgroundImage:[UIImage imageNamed:@"contacticon.png"] forState:UIControlStateNormal];
  ...
  [buttonBrowseUserGroup.button setBackgroundImage:[UIImage imageNamed:@"contacticon.png"] forState:UIControlStateNormal];
  ...
  [buttonBrowseWebsite.button setBackgroundImage:[UIImage imageNamed:@"contacticon.png"] forState:UIControlStateNormal];
